...
work_dir = 'work_dirs/lervicd/ttp_repklnet_31B_levircd'
...
vis_backends = [dict(type='CDLocalVisBackend'),
                dict(type='WandbVisBackend', init_kwargs=dict(project='repklnetcd', group='levircd', name='ttp_repklnet_31B_levircd'))
                ]
...
pretrain_ckpt_path = 'https://download.openmmlab.com/mmclassification/v0/replknet/replknet-31B_in21k-pre_3rdparty_in1k_20221118-54ed5c46.pth'
